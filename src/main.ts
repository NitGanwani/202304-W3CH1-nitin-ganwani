...
const fighterTemplate2 = `<li class="character col">
    <div class="card character__card">
      <img src="/public/daenerys.jpg" alt="Daenerys Targaryen" class="character__picture card-img-top" />
      <div class="card-body">
...
const advisorTemplate = `<li class="character col">
    <div class="card character__card">
      <img src="/public/tyrion.jpg" alt="Tyrion Lannister" class="character__picture card-img-top" />
      <div class="card-body">
...
const squireTemplate = `<li class="character col">
    <div class="card character__card">
      <img src="/public/bronn.jpg" alt="Bronn" class="character__picture card-img-top" />
      <div class="card-body">
